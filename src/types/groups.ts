...
export interface Group {
  ...
  isSystem?: boolean;
  /**
   * Курсы, которые админ группы помечает как «актуальные» для всех её
   * студентов. Показываются в continue-cards на /home, пока студент не убрал
   * их у себя в профиле. Без лимита; у системной «Все» не используются.
   */
