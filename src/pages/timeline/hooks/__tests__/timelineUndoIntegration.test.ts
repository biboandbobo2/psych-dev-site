...
describe('I10: undo/redo восстанавливает точное предыдущее состояние', () => {
  ...
  // Фиксация поведения, не регрессионный тест: в React 19 второй setup
  // StrictMode-эффекта видит обновлённый historyLength и без ref-guard;
  // sync-проверка в seedBaselineIfEmpty — defense-in-depth.
