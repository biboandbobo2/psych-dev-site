...
export const AdminTelemetry = lazy(() => lazyWithReload(() => import('./admin/telemetry/AdminTelemetry'), 'AdminTelemetry'));
export const AuthorCabinet = lazy(() => lazyWithReload(() => import('./admin/cabinet/AuthorCabinet'), 'AuthorCabinet'));
export const AdminGroups = lazy(() => lazyWithReload(() => import('./admin/groups/AdminGroups'), 'AdminGroups'));
export const AdminLectureQuestions = lazy(() => lazyWithReload(() => import('./admin/questions/AdminLectureQuestions'), 'AdminLectureQuestions'));
...
export const VozrastLandingPage = lazy(() => lazyWithReload(() => import('./VozrastLandingPage'), 'VozrastLandingPage'));
export const RetrainingLandingPage = lazy(() => lazyWithReload(() => import('./RetrainingLandingPage'), 'RetrainingLandingPage'));
export const AboutPage = lazy(() => lazyWithReload(() => import('./about/AboutPage'), 'AboutPage'));
export const DynamicProjectPage = lazy(() =>
