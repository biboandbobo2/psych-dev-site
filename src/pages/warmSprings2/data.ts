...
export const program: ProgramStep[] = [
  {
    ...
    text: 'Помогаем понять, подходит ли вам формат. Личная встреча с ведущими проясняет ваши цели, готовность к групповому процессу и вопросы, с которыми вы приходите.',
  },
  {
    step: '02',
    title: 'Онлайн-семинар',
    duration: '3 часа, за несколько дней до интенсива',
    text: 'Даём базу, чтобы вы не терялись в процессе: основы групповой психотерапии, методика «Тёплые ключи 2», принципы бифокального участия и правила безопасности.',
  },
  {
    step: '03',
    title: 'Очный интенсив в Тбилиси',
    duration: '3 дня, 18 часов',
    text: 'Практика + разбор + проживание. Пятница — встреча группы, разделение на подгруппы, начало терапевтических процессов. Суббота и воскресенье — поочерёдная смена ролей: активное участие, наблюдение и методические пояснения.',
  },
  {
    step: '04',
    title: 'Заключительный онлайн-семинар',
    duration: 'Через неделю после очной части',
    text: 'Помогаем бережно завершить групповые процессы, подводим итоги, разбираем работу группы и даём рекомендации для дальнейшей самостоятельной практики.',
  },
];
