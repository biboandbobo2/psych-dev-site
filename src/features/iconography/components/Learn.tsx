...
const steps = [
  {
    title: 'Найдите направление взгляда', icon: 'ru-95156256', name: 'Георгий в молении · деисусный ряд',
    question: 'Почему Георгий склонил голову и протянул раскрытые ладони за край доски?',
    answer: 'Он обращён ко Христу в центре деисусного ряда: руки подняты в молении, а не заняты копьём или мечом. Когда видите несколько фигур, повёрнутых друг к другу, мысленно восстановите их общую композицию.',
...
const rows: { name: string; text: string; belongs?: RegExp }[] = [
  ...
  { name: 'Деисусный ряд', text: 'Христос в центре; Богородица, Предтеча и другие святые обращены к Нему. Здесь находились Георгий и Николай из нашего разбора.', belongs: /Георгий|Николай/ },
