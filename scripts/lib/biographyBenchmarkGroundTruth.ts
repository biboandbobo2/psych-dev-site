...
export const biographyBenchmarkGroundTruth: Record<string, BiographyBenchmarkFact[]> = {
  ...
  james: [
    { id: 'birth', year: 1842, label: 'Born in New York City', critical: true, article: { all: [['new york']] }, timeline: { any: ['new york', 'born', '1842'] } },
    { id: 'md', year: 1869, label: 'MD at Harvard', critical: true, article: { all: [['harvard']] }, timeline: { any: ['harvard', 'md', 'medical'] } },
    { id: 'marriage', year: 1878, label: 'Married Alice Gibbens', article: { all: [['gibbens']] }, timeline: { any: ['gibbens', 'marri'] } },
    { id: 'principles', year: 1890, label: 'The Principles of Psychology', critical: true, article: { all: [['principles of psychology']] }, timeline: { any: ['principles of psychology', 'principles'] } },
    { id: 'varieties', year: 1902, label: 'The Varieties of Religious Experience', article: { all: [['varieties of religious experience']] }, timeline: { any: ['varieties'] } },
    { id: 'death', year: 1910, label: 'Death', critical: true, article: { any: ['died'] }, timeline: { any: ['died', 'death'] } },
  ],
  rogers: [
    { id: 'birth', year: 1902, label: 'Born in Oak Park', critical: true, article: { all: [['oak park']] }, timeline: { any: ['oak park', 'born', '1902'] } },
    { id: 'phd', year: 1931, label: 'PhD at Columbia', critical: true, article: { all: [['columbia']] }, timeline: { any: ['columbia', 'phd'] } },
    { id: 'counseling', year: 1942, label: 'Counseling and Psychotherapy', article: { all: [['counseling and psychotherapy']] }, timeline: { any: ['counseling'] } },
    { id: 'client-centered', year: 1951, label: 'Client-Centered Therapy', critical: true, article: { all: [['client-centered therapy']] }, timeline: { any: ['client-centered', 'client centered'] } },
    { id: 'becoming', year: 1961, label: 'On Becoming a Person', article: { all: [['on becoming a person']] }, timeline: { any: ['becoming a person'] } },
    { id: 'death', year: 1987, label: 'Death', critical: true, article: { any: ['died', 'death'] }, timeline: { any: ['died', 'death'] } },
  ],
  freud: [
  ...
  erikson: [
    { id: 'birth', year: 1902, label: 'Born in Frankfurt', critical: true, article: { all: [['frankfurt']] }, timeline: { any: ['frankfurt', 'born', '1902'] } },
    { id: 'anna-freud', year: 1927, label: 'Study with Anna Freud in Vienna', critical: true, article: { all: [['anna freud']] }, timeline: { any: ['anna freud', 'vienna'] } },
    { id: 'emigration', year: 1933, label: 'Emigration to the United States', critical: true, article: { any: ['united states', 'boston'] }, timeline: { any: ['united states', 'america', 'boston', 'emigrat'] } },
    { id: 'childhood-society', year: 1950, label: 'Childhood and Society', critical: true, article: { all: [['childhood and society']] }, timeline: { any: ['childhood and society'] } },
    { id: 'death', year: 1994, label: 'Death', critical: true, article: { any: ['died', 'death'] }, timeline: { any: ['died', 'death'] } },
  ],
  lomonosov: [
  ...
  wundt: [
    { id: 'birth', year: 1832, label: 'Born in Neckarau', critical: true, article: { any: ['neckarau'] }, timeline: { any: ['neckarau', 'born', '1832'] } },
    { id: 'helmholtz', year: 1858, label: 'Assistant to Helmholtz', critical: true, article: { all: [['helmholtz']] }, timeline: { any: ['helmholtz', 'heidelberg'] } },
    { id: 'principles', year: 1874, label: 'Principles of Physiological Psychology', critical: true, article: { all: [['physiological psychology']] }, timeline: { any: ['physiological psychology'] } },
    { id: 'leipzig', year: 1875, label: 'Professor at Leipzig', critical: true, article: { all: [['leipzig']] }, timeline: { any: ['leipzig'] } },
    { id: 'laboratory', year: 1879, label: 'First psychology laboratory', critical: true, article: { all: [['laborator']] }, timeline: { any: ['laborator'] } },
    { id: 'death', year: 1920, label: 'Death', critical: true, article: { any: ['died', 'death'] }, timeline: { any: ['died', 'death'] } },
  ],
  frankl: [
  ...
  skinner: [
    { id: 'birth', year: 1904, label: 'Born in Susquehanna', critical: true, article: { any: ['susquehanna'] }, timeline: { any: ['susquehanna', 'born', '1904'] } },
    { id: 'phd', year: 1931, label: 'PhD at Harvard', critical: true, article: { all: [['harvard']] }, timeline: { any: ['harvard', 'phd'] } },
    { id: 'behavior-organisms', year: 1938, label: 'The Behavior of Organisms', critical: true, article: { all: [['behavior of organisms']] }, timeline: { any: ['behavior of organisms'] } },
    { id: 'walden', year: 1948, label: 'Walden Two', article: { all: [['walden two']] }, timeline: { any: ['walden'] } },
    { id: 'death', year: 1990, label: 'Death', critical: true, article: { any: ['died', 'death', 'leukemia'] }, timeline: { any: ['died', 'death'] } },
  ],
  curie: [
  ...
  piaget: [
    { id: 'birth', year: 1896, label: 'Born in Neuchâtel', critical: true, article: { any: ['neuchatel', 'neuchâtel'] }, timeline: { any: ['neuchatel', 'born', '1896'] } },
    { id: 'phd', year: 1918, label: 'PhD in natural sciences', critical: true, article: { any: ['doctorate', 'phd'] }, timeline: { any: ['doctorate', 'phd'] } },
    { id: 'rousseau', year: 1921, label: 'Rousseau Institute in Geneva', critical: true, article: { any: ['rousseau'] }, timeline: { any: ['rousseau', 'geneva'] } },
    { id: 'death', year: 1980, label: 'Death', critical: true, article: { any: ['died', 'death'] }, timeline: { any: ['died', 'death'] } },
  ],
};
