...
| Маршрут | Компонент | Описание |
|---------|-----------|----------|
| `/booking` | `BookingPage` | Страница бронирования кабинетов в психологическом центре «Дом» в Тбилиси. Пока — placeholder со ссылкой на связь с администрацией; будущее подключение к сервису бронирования партнёра. |
