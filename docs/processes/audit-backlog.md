...
|----|----------|-------|-----------------------|
| HP-2 | L (S) | Ролевой e2e-стенд: остатки | Стенд реализован 2026-08-29 (`npm run smoke:roles`: вход под любой ролью без OAuth, сид, песочницы, 16 сценариев кабинета автора — testing-system.md «Ролевой стенд»). Осталось: e2e-job в CI, stress-тесты |
