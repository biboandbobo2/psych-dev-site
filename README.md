...
- Подробный анализ релевантности: [docs/RESEARCH_SEARCH_ANALYSIS.md](docs/RESEARCH_SEARCH_ANALYSIS.md)
...
- 🧪 **Testing System Guide:** [docs/TestingSystemGuide.md](docs/TestingSystemGuide.md) — устройство тестовой системы, хранилище данных, рекомендации по написанию тестов.
- 🎓 **Multi-Course Integration:** [docs/MULTI_COURSE_INTEGRATION.md](docs/MULTI_COURSE_INTEGRATION.md) — документация по интеграции трёх курсов (развития, клинической, общей психологии), архитектурные решения, формат данных.
