...
5. Построй mainEvents:
   ...
   - Главная линия обязана покрывать все периоды жизни. Не концентрируй всё в одном периоде.
     * Детство и юность (0-18): минимум 2-3 события (рождение, семья, школа, формирующие моменты).
     * Становление (18-30): начало карьеры, первые достижения, ключевые переезды.
...
6. Построй branches:
   ...
   - БАЛАНС: старайся, чтобы ветки покрывали разные сферы жизни (например, литература + семья + друзья, а не три литературных ветки).
   ...
   - Ветки могут покрывать РАЗНЫЕ временные диапазоны. Не все ветки должны тянуться от начала до конца жизни.
...
- Перед смертью/финалом покажи причинно-следственную цепь.
- Разнообразие сфер на главной линии: минимум 3-4 разных sphere.
