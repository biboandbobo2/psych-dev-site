...
5. Построй mainEvents:
   ...
   - Это должны быть вехи: рождение, раннее семейное формирование, учёба, ключевые публикации/прорывы, ссылки/опалы, брак, переломы судьбы, кризисы, смерть и т.д.
   - Главная линия обязана покрывать все периоды жизни. Не концентрируй всё в одном периоде.
     * КРИТИЧЕСКИ ВАЖНО: в каждом 5-летнем периоде жизни (0-5, 5-10, 10-15, ...) должно быть хотя бы одно событие (на главной линии или в ветке), если биография даёт для этого опору.
     * Детство и юность (0-18): минимум 2-3 события. Если источник даёт опору до 12 лет, обязательно покажи 1-3 события в этом диапазоне.
     * Становление (18-30): начало карьеры/творчества, первые достижения, ключевые переезды, важные связи.
     * Зрелость (30+): кульминация, кризисы, поздние конфликты, финал жизни. Последние годы жизни особенно важны — не оставляй их пустыми.
