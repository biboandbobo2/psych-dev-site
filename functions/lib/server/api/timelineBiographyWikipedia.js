...
const NON_BIOGRAPHY_SECTION_PATTERN = /^(?:См\. также|Примечания|Комментарии|Литература|Ссылки|Библиография|Переводы(?:\s+.*)?|Мировое признание(?:\.\s*Память)?|В культуре(?:\s+.*)?|.+\s+в культуре(?:\s+.*)?|В документальных фильмах и сериалах|В игровых фильмах и сериалах|Камео|В мультипликации|В музыке|В видеоиграх|В ботанике|В кулинарии|В филателии и нумизматике|В филателии|В нумизматике|В кинематографе|В театре|В топонимике|Природные объекты|Городские объекты|Суда|В Википедии|Память|Памятники|Прижизненные памятники|Посмертные памятники|Музеи|Живопись|Кино|Значение и влияние(?: творчества)?|Писатели, мыслители и религиозные деятели о|Критика(?: .*)?|Экранизации(?:\s+.*)?|Поп-культура|Прижизненные и посмертные издания собраний сочинений|Работы толстовцев|Тематические обзоры и мемуары|Отзывы критиков и деятелей культуры|Использованная литература и источники|Книги|Статьи|Академические исследования|Собрания сочинений|Отдельные издания|Сочинения .*|Последняя статья .*|Кинохроника и аудиозаписи|Официальные титулы, награды и герб|Титулы .*|Награды|Награды имени .*|Герб|Церемониал .*|Общественное восприятие|Критика|Личные качества|Хобби|Творчество|Галерея(?:\s+.*)?|Увековечивание памяти .*|Разное|Стихи|Аудиокниги(?:\s.*)?|Образ .+ в .+ кино|.+-художник)$/iu;
