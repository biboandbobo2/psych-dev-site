import { TIMELINE_PERIODIZATION_IDS, normalizeText, normalizeSphere, pickBranchX, russianDateToISO, sanitizeTimelineEventPlan, LINE_X_POSITION, } from './timelineBiographyHeuristics.js';
import { SPHERE_META, } from './timelineBiographyTypes.js';
const SAME_AGE_MAIN_EVENT_OFFSETS = [0, -260, 260, -460, 460, -680, 680];
export function buildTimelineDataFromBiographyPlan(plan) {
    ...
    const edges = [];
    const mainNodeIds = [];
    const mainAgeCounts = new Map();
    const mainAgeSeen = new Map();
    ...
    return {
        ...
        selectedPeriodization: typeof plan.selectedPeriodization === 'string' &&
