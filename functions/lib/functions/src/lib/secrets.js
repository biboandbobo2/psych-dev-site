...
export async function readLatestSecretValue(secretName, projectId = resolveAdminProjectId()) {
    if (!projectId) {
...
export async function tryReadLatestSecretValue(secretName, projectId = resolveAdminProjectId()) {
    try {
