const DEVELOPMENT_LESSON_PATHS = {
    intro: "/intro",
    prenatal: "/prenatal",
    infancy: "/0-1",
    toddler: "/1-3",
...
const DEVELOPMENT_PERIOD_ORDER = {
    intro: 0,
    prenatal: 1,
    infancy: 2,
    toddler: 3,
...
function getStaticCourseLessonPath(courseId, periodId) {
...
export function getCoursePeriodOrder(courseId, periodId) {
    if (courseId === "development") {
...
export function buildCourseLessonPath(courseId, periodId) {
...
export function compareLectureOrder(left, right) {
    const orderDiff = getCoursePeriodOrder(left.courseId, left.periodId) -
...
export function groupLectureSourcesByCourse(sources) {
