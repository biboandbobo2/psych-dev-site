...
const {
  mockAdd, mockUpdate, mockDelete, mockGet, mockDocRef, mockDoc, mockCollection,
  mockGetUserByEmail,
} = vi.hoisted(() => {
  const mockAdd = vi.fn();
  ...
  return { mockAdd, mockUpdate, mockDelete, mockGet, mockDocRef, mockDoc, mockCollection, mockGetUserByEmail };
});
